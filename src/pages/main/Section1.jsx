    ...
    return (
        <section className='sec1'>
                ...
                <div className='img_box'>
                    <div>
                        <img src={getAssetsImgUrl(imageNames[currentImageIndex])} alt={`예절원소개 썸네일이미지${currentImageIndex + 1}`} />
                    </div>
                    <ul>
                        {imageNames.map((name, index) => (
                            ...
                            >
                            <img src={getAssetsImgUrl(`${name}_thum`)} alt={`예절원소개 이미지${currentImageIndex + 1}`}  />
                        </li>
                    ))}
                    </ul>
                </div>
